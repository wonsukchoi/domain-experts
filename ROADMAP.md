...
**Progress: 927 / 1016 O*NET occupations drafted · 0 drafted roles awaiting spec-2 upgrade.**
...
<details>
<summary><strong>51 — Production</strong> (107/114 drafted)</summary>
...
| ✅ | 51-3023.00 | Slaughterers and Meat Packers | [`slaughterer-meat-packer`](./roles/slaughterer-meat-packer/SKILL.md) |
...
| ✅ | 51-3093.00 | Food Cooking Machine Operators and Tenders | [`food-cooking-machine-operator`](./roles/food-cooking-machine-operator/SKILL.md) |
...
| ✅ | 51-4022.00 | Forging Machine Setters, Operators, and Tenders, Metal and Plastic | [`forging-machine-operator`](./roles/forging-machine-operator/SKILL.md) |
| ✅ | 51-4023.00 | Rolling Machine Setters, Operators, and Tenders, Metal and Plastic | [`rolling-machine-operator`](./roles/rolling-machine-operator/SKILL.md) |
| ✅ | 51-4031.00 | Cutting, Punching, and Press Machine Setters, Operators, and Tenders, Metal and Plastic | [`punch-press-operator`](./roles/punch-press-operator/SKILL.md) |
| ✅ | 51-4032.00 | Drilling and Boring Machine Tool Setters, Operators, and Tenders, Metal and Plastic | [`drilling-boring-machine-operator`](./roles/drilling-boring-machine-operator/SKILL.md) |
...
| ✅ | 51-4034.00 | Lathe and Turning Machine Tool Setters, Operators, and Tenders, Metal and Plastic | [`lathe-turning-machine-operator`](./roles/lathe-turning-machine-operator/SKILL.md) |
| ✅ | 51-4035.00 | Milling and Planing Machine Setters, Operators, and Tenders, Metal and Plastic | [`milling-planing-machine-operator`](./roles/milling-planing-machine-operator/SKILL.md) |
...
| ✅ | 51-4062.00 | Patternmakers, Metal and Plastic | [`metal-plastic-patternmaker`](./roles/metal-plastic-patternmaker/SKILL.md) |
...
| ✅ | 51-4081.00 | Multiple Machine Tool Setters, Operators, and Tenders, Metal and Plastic | [`multiple-machine-tool-operator`](./roles/multiple-machine-tool-operator/SKILL.md) |
...
| ✅ | 51-4122.00 | Welding, Soldering, and Brazing Machine Setters, Operators, and Tenders | [`welding-soldering-brazing-machine-operator`](./roles/welding-soldering-brazing-machine-operator/SKILL.md) |
...
| ✅ | 51-4194.00 | Tool Grinders, Filers, and Sharpeners | [`tool-grinder-sharpener`](./roles/tool-grinder-sharpener/SKILL.md) |
...
| ✅ | 51-6051.00 | Sewers, Hand | [`hand-sewer`](./roles/hand-sewer/SKILL.md) |
...
| ✅ | 51-6064.00 | Textile Winding, Twisting, and Drawing Out Machine Setters, Operators, and Tenders | [`textile-winding-twisting-machine-operator`](./roles/textile-winding-twisting-machine-operator/SKILL.md) |
...
| ✅ | 51-7031.00 | Model Makers, Wood | [`wood-model-maker`](./roles/wood-model-maker/SKILL.md) |
| ✅ | 51-7032.00 | Patternmakers, Wood | [`wood-patternmaker`](./roles/wood-patternmaker/SKILL.md) |
| ✅ | 51-7041.00 | Sawing Machine Setters, Operators, and Tenders, Wood | [`wood-sawing-machine-operator`](./roles/wood-sawing-machine-operator/SKILL.md) |
...
| ✅ | 51-8013.04 | Hydroelectric Plant Technicians | [`hydroelectric-plant-technician`](./roles/hydroelectric-plant-technician/SKILL.md) |
...
| ✅ | 51-9041.00 | Extruding, Forming, Pressing, and Compacting Machine Setters, Operators, and Tenders | [`extruding-forming-machine-operator`](./roles/extruding-forming-machine-operator/SKILL.md) |
| ✅ | 51-9051.00 | Furnace, Kiln, Oven, Drier, and Kettle Operators and Tenders | [`furnace-kiln-oven-operator`](./roles/furnace-kiln-oven-operator/SKILL.md) |
...
| ✅ | 51-9071.06 | Gem and Diamond Workers | [`gem-diamond-worker`](./roles/gem-diamond-worker/SKILL.md) |
...
| ✅ | 51-9123.00 | Painting, Coating, and Decorating Workers | [`painting-coating-decorating-worker`](./roles/painting-coating-decorating-worker/SKILL.md) |
...
| ✅ | 51-9195.03 | Stone Cutters and Carvers, Manufacturing | [`stone-cutter-carver-manufacturing`](./roles/stone-cutter-carver-manufacturing/SKILL.md) |
...
| ✅ | 51-9198.00 | Helpers--Production Workers | [`helper-production-worker`](./roles/helper-production-worker/SKILL.md) |
...
**Queue empty — every drafted role is at spec 2.** 🎉
...
| [`brewmaster`](./roles/brewmaster/SKILL.md) | _(reason not documented yet — add to UNMAPPED_NOTES in scripts/generate_roadmap.py)_ |
| [`central-bank-governor`](./roles/central-bank-governor/SKILL.md) | ESCO-sourced role (ISCO 1112.1); no distinct O*NET occupation — O*NET's `11-1011.00` Chief Executives (taken by `chief-executive`) is a generic private-sector executive category that doesn't capture the monetary-policy/lender-of-last-resort judgment this role centers on. |
...
| [`correctional-services-manager`](./roles/correctional-services-manager/SKILL.md) | ESCO-sourced role (ISCO 1349.10); no distinct O*NET occupation — closest broad match (`11-9199.00` Managers, All Other) is a residual catch-all that doesn't capture the classification/staffing-safety/legal-liability judgment this role centers on. |
| [`costume-designer`](./roles/costume-designer/SKILL.md) | ESCO-sourced role (ISCO 2163.1.2); no distinct O*NET occupation — closest candidate (`39-3092.00` Costume Attendants, taken by `costume-attendant`) covers nightly quick-change execution, not the pre-production concept/sourcing/build-vs-rent judgment this role centers on. |
...
| [`demographer`](./roles/demographer/SKILL.md) | ESCO-sourced role (ISCO 2120.2); no distinct O*NET occupation — closest candidates (`15-2041.00` Statisticians and `19-3011.00` Economists) are discipline-general and don't capture the cohort-component projection, vital-statistics reconciliation, and census-undercount judgment this role centers on. |
...
| [`marine-surveyor`](./roles/marine-surveyor/SKILL.md) | ESCO-sourced role (ISCO 3115.1.8); no distinct O*NET occupation — closest candidates (`17-2121.00` Marine Engineers and Naval Architects, taken by `marine-engineer-naval-architect`, and `53-6051.00` Transportation Inspectors, taken by `cargo-inspector`) are design-framed or cargo-quantity-framed and don't capture the classification-society condition/class-status inspection judgment this role centers on. |
| [`mine-supervisor`](./roles/mine-supervisor/SKILL.md) | ESCO-sourced (3121.1), no O*NET-SOC match; closest O*NET candidates (`11-9021.00` Construction Managers, `47-1011.00` First-Line Supervisors of Construction Trades) are non-mining generalists that miss the MSHA-certification and roof-control/ventilation-plan scope specific to this role. |
...
| [`storyboard-artist`](./roles/storyboard-artist/SKILL.md) | ESCO-sourced role (ISCO 2651.11); no distinct O*NET occupation — closest candidates (`27-1013.00` Fine Artists and `27-1014.00` Special Effects Artists and Animators) are medium-framed (painting/CGI) rather than the coverage/continuity and pre-production planning judgment this role centers on. |
