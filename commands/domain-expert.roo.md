...
Route the task described in this message to the best-matching role in the [domain-experts](https://github.com/wonsukchoi/domain-experts) library, and reason as that expert.

1. Run: `npx --yes domain-experts match "<the task, verbatim>" --json`
2. If `confident: true`:
