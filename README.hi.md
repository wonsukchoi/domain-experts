...
> **अगर आपने CLI की जगह इस repo को `git clone` किया है:** अपने टूल की स्किल-डिस्कवरी को सीधे `roles/` डायरेक्टरी पर पॉइंट न करें। इस डायरेक्टरी में 200 से ज़्यादा अलग-अलग `SKILL.md` फाइलें हैं, और ज़्यादातर टूल (Claude Code सहित) हर डिस्कवर हुई स्किल का नाम और डिस्क्रिप्शन बेस सिस्टम प्रॉम्प्ट में लोड कर देते हैं — आप हर सेशन में उन रोल्स के लिए टोकन कॉस्ट चुकाएंगे जिन्हें कभी इस्तेमाल ही नहीं करते। सिर्फ [`skills/domain-expert-router/SKILL.md`](./skills/domain-expert-router/SKILL.md) इंस्टॉल करें (या CLI के `add`/`init` कमांड इस्तेमाल करें, जो यही काम करते हैं) — यह एक हल्की सिंगल स्किल है जो सिर्फ ज़रूरत पड़ने पर किसी खास `roles/<slug>/SKILL.md` को ऑन-डिमांड पढ़ती है।
...
पूरा स्पेक, रूब्रिक, और LLM ड्राफ्टिंग पाइपलाइन: [`AUTHORING.md`](./AUTHORING.md)। Claude Code checkout में, यह पूरा पाइपलाइन `/generate-role "<need>"` के रूप में चलता है — नीचे [मेंटेनर ऑटोमेशन](#maintainer-automation-claude-code) देखें।
...
### मेंटेनर ऑटोमेशन (Claude Code)

इस रिपो के Claude Code checkout में काम करने पर तीन slash commands जुड़ जाते हैं जो ऊपर के पाइपलाइन को बदलने के बजाय ऑटोमेट करते हैं — हर एक ह्यूमन-PR-गेटेड है, कोई भी अपने-आप `main` में कमिट या पब्लिश नहीं करता:

- `/generate-role "<need>"` — किसी फ्री-टेक्स्ट ज़रूरत को किसी मौजूदा रोल, नए स्पेशलाइज़ेशन लीफ़, या नए पैरेंट रोल से मैच करता है, फिर AUTHORING.md का Pass 0-4 पाइपलाइन (रिसर्च → ड्राफ्ट → adversarial critique → स्कोर, अधिकतम 2 रिविज़न लूप तक सीमित) चलाता है और एक PR खोलता है।
- `/audit-roles [batchSize]` — शिप हो चुके रोल्स की रूब्रिक और सोर्स की ताज़गी के आधार पर बैच में दोबारा स्कोरिंग; `last_audited`/`audit_score` स्टैम्प करता है, `status: needs-refresh` फ़्लैग करता है, और लगातार दूसरी बार फेल होने पर डिप्रिकेट कर देता है (`roles/_deprecated/` में ले जाकर)।
- `/scan-project <path>` — किसी बाहरी प्रोजेक्ट का रीड-ओनली स्कैन (स्टैक, README, स्ट्रक्चर, हालिया कमिट्स), मौजूदा कवरेज से क्रॉस-चेक की गई कैंडिडेट ज़रूरतें सुझाता है, और आपके चुने हुए को `/generate-role` को सौंप देता है। स्कैन किए गए प्रोजेक्ट के बारे में कहीं भी कुछ नहीं लिखा जाता।

गैर-कॉन्फ़िडेंट `match` क्वेरीज़ `data/gap-log.jsonl` में लॉग होती हैं और फ़्रीक्वेंसी के हिसाब से रैंक होकर [`ROADMAP.md`](./ROADMAP.md) के "Requested but missing" सेक्शन में दिखाई जाती हैं — यह इस बात का ठोस संकेत है कि आगे क्या ड्राफ़्ट किया जाए।
