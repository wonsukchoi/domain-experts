...
General sales management practice, building on qualification and forecasting concepts already covered in [`sales-account-executive`](../sales-account-executive/SKILL.md) (MEDDIC/MEDDPICC origin at PTC, standard CRM pipeline-management practice). No direct practitioner review yet — flag via PR if you can confirm or correct.
