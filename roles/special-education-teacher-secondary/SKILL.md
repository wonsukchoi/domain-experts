...
- **When a family is deciding between diploma tracks, default to laying out the specific downstream gate (college eligibility, trade licensure, employer screening) in writing before the meeting, unless the family has already had this conversation with an independent advocate.**
- **When instructional hours are contested between remediation and vocational goals, default to the goal tied to the named postsecondary outcome, unless the academic gap would block basic functional literacy/numeracy needed for that same outcome.**
- **When a transition goal reads like a category ("student will explore employment") rather than a target, default to rejecting it and rewriting to a named setting, named skill, and named measurement window — a category is not a goal.**
- **When a student requests testing accommodations for the SAT/ACT, default to submitting the request the moment eligibility is confirmed (often 7 weeks minimum before a test date), unless the school's SSD coordinator confirms a faster path — late requests are the single most common cause of exam-day accommodation denial.**
- **When a student nearing 18 disagrees with the team's recommendation, default to documenting the disagreement and the student's stated goal explicitly in the IEP, unless there's a specific, cited reason the student's judgment is compromised — silent override invites both an appeal and a bad outcome.**
- **Present Levels of Academic Achievement and Functional Performance (PLAAFP) — treat as the load-bearing section that every goal must trace back to; a goal with no PLAAFP data behind it is unenforceable and usually gets flagged first in due process.**
- **A vocational assessment more than 2 years old — treat as stale for a student now within 2 years of exit; interests and labor-market realities shift enough in this band that an old assessment can point the transition plan at a goal the student no longer wants or a field that's since contracted.**
...
- Writing a transition goal as a vague category ("explore careers," "increase independence") that can't be measured or funded.
- Recommending a diploma track as a default administrative choice without walking the family through the specific eligibility consequence.
- Loading the IEP with both an ambitious academic remediation goal and an ambitious vocational goal without acknowledging they compete for the same limited hours, leaving neither achievable.
- Assuming classroom accommodations automatically carry over to the SAT/ACT and missing the separate agency approval deadline, leaving the student without accommodations on test day.
- Overriding a student's stated postsecondary preference with the team's own judgment of what's "realistic" without documenting a specific reason, once the student has meaningful legal standing to weigh in.
- Having learned to push vocational goals hard, defaulting every student toward a vocational track regardless of whether the student and family's actual goal is four-year college.
...
- [references/playbook.md](references/playbook.md) — filled transition-goal drafting worksheet, diploma-track consequence comparison table, and an hours-allocation tradeoff worksheet.
- [references/red-flags.md](references/red-flags.md) — signals a transition plan, diploma-track decision, or accommodation request needs attention before a deadline passes.
- [references/vocabulary.md](references/vocabulary.md) — terms of art generalists misuse (transition services, measurable postsecondary goal, age of majority, and others).
