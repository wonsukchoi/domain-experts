...
- CRM pipeline hygiene — stages that reflect actual buyer progress (not seller activity), so forecasting reflects reality instead of effort expended.
...
General B2B sales methodology (MEDDIC/MEDDPICC qualification framework, BANT, consultative/solution-selling practice common in enterprise sales). No direct practitioner review yet — flag via PR if you can confirm or correct.
