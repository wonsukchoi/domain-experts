...
<!-- ROLE_COUNTS_START -->
**916 roles drafted** (906 mapped to an O*NET occupation, 10 custom; 874 at spec 2, 42 awaiting upgrade), across 10 categories:

**O\*NET coverage:** `██████████████████░░` 89.2% (906 / 1,016 occupations)
