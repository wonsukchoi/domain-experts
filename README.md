...
<!-- ROLE_COUNTS_START -->
**912 roles drafted** (902 mapped to an O*NET occupation, 10 custom; 870 at spec 2, 42 awaiting upgrade), across 10 categories:

**O\*NET coverage:** `██████████████████░░` 88.8% (902 / 1,016 occupations)
