...
<!-- ROLE_COUNTS_START -->
**918 roles drafted** (908 mapped to an O*NET occupation, 10 custom; 876 at spec 2, 42 awaiting upgrade), across 10 categories:

**O\*NET coverage:** `██████████████████░░` 89.4% (908 / 1,016 occupations)
