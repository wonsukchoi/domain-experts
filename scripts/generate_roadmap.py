...
UNMAPPED_NOTES = {
    ...
    "costume-designer": "ESCO-sourced role (ISCO 2163.1.2); no distinct O*NET occupation — closest candidate (`39-3092.00` Costume Attendants, taken by `costume-attendant`) covers nightly quick-change execution, not the pre-production concept/sourcing/build-vs-rent judgment this role centers on.",
